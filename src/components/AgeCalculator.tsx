        ...
        <div className="bg-white w-[343px] h-[486px] rounded-[24px] rounded-br-[100px] flex flex-col px-[24px] py-[48px] gap-[32px]">
            ...
            <div className="flex w-full">
                <button onClick={handleClick} className='hover:cursor-pointer'>
                    <img src="icon-arrow.svg" alt="down-arrow" className='w-[64px] h-[64px] rounded-full bg-purple' />
                </button>
            </div>
            <div className='flex flex-col text-mobile-lg font-extrabold'>
                <div className='flex'><span className='text-purple'>{year}</span> years</div>
                <div className='flex'><span className='text-purple'>{month}</span> months</div>
                <div className='flex'><span className='text-purple'>{day}</span> days</div>
            </div>
